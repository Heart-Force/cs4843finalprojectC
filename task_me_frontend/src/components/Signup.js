...
import {SIGN_UP_URL} from '../constants/Constants.js';
      ...
      <form className="container my-5 p-5" style={{borderRadius: "20px", width: ""}}>
            ...
            <Col sm={12} lg={6}>
                ...
                <div className="d-grid gap-2 mt-3">
                        <Button variant="outline-dark" onClick={this.handleSubmit}>Sign Up</Button>
                        <NavLink to="/" className="btn btn-outline-dark" style={{display: "inline-block"}}>Already have an account? Sign In</NavLink>
                      </div>
